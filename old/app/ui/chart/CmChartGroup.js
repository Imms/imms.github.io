...
var ChartGroupProps = (function () {
    function ChartGroupProps() {
    }
    return ChartGroupProps;
}());
var CmChartGroup = (function (_super) {
    ...
    CmChartGroup.prototype.toSeries = function () {
        ...
        var dataSets = targets.map(function (target, i) {
            var results = group.tests.map(function (test) { return test.results.find(function (r) { return r.target === target.target; }); }).map(function (x) { return x ? helpers_1.Num.sigFigs(x.result, 3) : null; });
