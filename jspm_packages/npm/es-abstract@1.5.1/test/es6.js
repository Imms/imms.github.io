...
test('ToInt16', function(t) {
  ...
  t.throws(function() {
    return ES.ToInt16(uncoercibleObject);
  }, TypeError, 'uncoercibleObject throws');
...
test('ToInt8', function(t) {
  ...
  t.throws(function() {
    return ES.ToInt8(uncoercibleObject);
  }, TypeError, 'uncoercibleObject throws');
...
test('ToUint8', function(t) {
  ...
  t.throws(function() {
    return ES.ToUint8(uncoercibleObject);
  }, TypeError, 'uncoercibleObject throws');
...
test('ToUint8Clamp', function(t) {
  ...
  t.throws(function() {
    return ES.ToUint8Clamp(uncoercibleObject);
  }, TypeError, 'uncoercibleObject throws');
...
test('ToString', function(t) {
  ...
  if (hasSymbols) {
    t.throws(function() {
      return ES.ToString(Symbol.iterator);
    }, TypeError, debug(Symbol.iterator) + ' throws');
  }
  t.end();
});
...
test('ToLength', function(t) {
  t.throws(function() {
    return ES.ToLength(uncoercibleObject);
  }, TypeError, 'uncoercibleObject throws a TypeError');
...
test('CanonicalNumericIndexString', function(t) {
  var throwsOnNonString = function(notString) {
    ...
    }, TypeError, notString + ' is not a string');
  };
...
test('Call', function(t) {
  ...
  var throwsOnCall = function(notFunc) {
    ...
    }, TypeError, notFunc + ' (' + typeof notFunc + ') is not callable');
  };
