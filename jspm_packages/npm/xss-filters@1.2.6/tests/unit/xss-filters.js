...
(function() {
  ...
  describe("xss-filters: state transition tests", function() {
    ...
    it('filter inHTMLComment state transition test', function() {
      testutils.test_yc(filter.inHTMLComment, ['-- > --! > <!--[if IE] ><script>alert("yahoo\'s filters")</script>', 'foo-- ', 'foo--! ', '[if IE] ', 'foo- ', 'foo- ', ' ><script>alert(1)</script>', '---------- ><script>alert(1)</script>', '--\uFFFD>']);
    });
    it('filter inSingleQuotedAttr state transition test', function() {
      testutils.test_yav(filter.inSingleQuotedAttr, ['foo&<>&#39;"` \t\n\v\f\r', '\f', '', '&#39;&#39;', ' &#39;&#39;', '\t&#39;&#39;', '\n&#39;&#39;', '\f&#39;&#39;', '""', ' ""', '\t""', '\n""', '\f""', '``', ' ``', '\t``', '\n``', '\f``']);
    });
    it('filter inDoubleQuotedAttr state transition test', function() {
      testutils.test_yav(filter.inDoubleQuotedAttr, ['foo&<>\'&quot;` \t\n\v\f\r', '\f', '', "''", " ''", "\t''", "\n''", "\f''", '&quot;&quot;', ' &quot;&quot;', '\t&quot;&quot;', '\n&quot;&quot;', '\f&quot;&quot;', '``', ' ``', '\t``', '\n``', '\f``']);
    });
    it('filter inUnQuotedAttr state transition test', function() {
      testutils.test_yav(filter.inUnQuotedAttr, ['foo&&lt;&gt;&#39;&quot;&#96;&#32;&#9;&#10;&#11;&#12;&#13;', '&#12;', '\uFFFD', "&#39;&#39;", "&#32;&#39;&#39;", "&#9;&#39;&#39;", "&#10;&#39;&#39;", "&#12;&#39;&#39;", '&quot;&quot;', '&#32;&quot;&quot;', '&#9;&quot;&quot;', '&#10;&quot;&quot;', '&#12;&quot;&quot;', '&#96;&#96;', '&#32;&#96;&#96;', '&#9;&#96;&#96;', '&#10;&#96;&#96;', '&#12;&#96;&#96;']);
    });
    it('filter uriInSingleQuotedAttr state transition test', function() {
      testutils.test_yav(filter.uriInSingleQuotedAttr, ['foo&%3C%3E&#39;%22%60%20%09%0A%0B%0C%0D', '%0C', '', '&#39;&#39;', '%20&#39;&#39;', '%09&#39;&#39;', '%0A&#39;&#39;', '%0C&#39;&#39;', '%22%22', '%20%22%22', '%09%22%22', '%0A%22%22', '%0C%22%22', '%60%60', '%20%60%60', '%09%60%60', '%0A%60%60', '%0C%60%60']);
      testutils.test_yufull(filter.uriInSingleQuotedAttr, [null, null, null, null, null, 'http://[2001:0db8:85a3:0000:0000:8a2e:0370:7334]', null, null]);
      testutils.test_yubl(filter.uriInSingleQuotedAttr);
    });
    it('filter uriInDoubleQuotedAttr state transition test', function() {
      testutils.test_yav(filter.uriInDoubleQuotedAttr, ['foo&%3C%3E\'%22%60%20%09%0A%0B%0C%0D', '%0C', '', '\'\'', '%20\'\'', '%09\'\'', '%0A\'\'', '%0C\'\'', '%22%22', '%20%22%22', '%09%22%22', '%0A%22%22', '%0C%22%22', '%60%60', '%20%60%60', '%09%60%60', '%0A%60%60', '%0C%60%60']);
      testutils.test_yufull(filter.uriInDoubleQuotedAttr, [null, null, null, null, null, 'http://[2001:0db8:85a3:0000:0000:8a2e:0370:7334]', null, null]);
      testutils.test_yubl(filter.uriInDoubleQuotedAttr);
    });
    it('filter uriInUnQuotedAttr state transition test', function() {
      testutils.test_yav(filter.uriInUnQuotedAttr, ['foo&%3C%3E&#39;%22%60%20%09%0A%0B%0C%0D', '%0C', '\uFFFD', '&#39;&#39;', '%20&#39;&#39;', '%09&#39;&#39;', '%0A&#39;&#39;', '%0C&#39;&#39;', '%22%22', '%20%22%22', '%09%22%22', '%0A%22%22', '%0C%22%22', '%60%60', '%20%60%60', '%09%60%60', '%0A%60%60', '%0C%60%60']);
      testutils.test_yufull(filter.uriInUnQuotedAttr, ['http://6.6.6.6/?q&#61;%5Bsomewhere%5D', null, null, null, null, 'http://[2001:0db8:85a3:0000:0000:8a2e:0370:7334]', null, '%5B%5D?&&#61;#/:;']);
    ...
    it('filter uriInHTMLData state transition test', function() {
      ...
      testutils.test_yufull(filter.uriInHTMLData, [null, null, null, null, null, 'http://[2001:0db8:85a3:0000:0000:8a2e:0370:7334]', null, null]);
    });
    it('filter uriInHTMLComment state transition test', function() {
      testutils.test_yc(filter.uriInHTMLComment, ['--%3E%20--!%3E%20%3C!--%5Bif%20IE%5D%3E%3Cscript%3Ealert(%22yahoo\'s%20filters%22)%3C/script%3E', 'foo-- ', 'foo--! ', '%5Bif%20IE%5D', 'foo- ', 'foo- ', '%3E%3Cscript%3Ealert(1)%3C/script%3E', '----------%3E%3Cscript%3Ealert(1)%3C/script%3E', '--%00%3E']);
      testutils.test_yufull(filter.uriInHTMLComment, [null, null, null, null, null, 'http://[2001:0db8:85a3:0000:0000:8a2e:0370:7334] ', null, null]);
    });
    it('filter uriPathInSingleQuotedAttr state transition test', function() {
      testutils.test_yav(filter.uriPathInSingleQuotedAttr, ['foo&%3C%3E&#39;%22%60%20%09%0A%0B%0C%0D', '%0C', '', '&#39;&#39;', '%20&#39;&#39;', '%09&#39;&#39;', '%0A&#39;&#39;', '%0C&#39;&#39;', '%22%22', '%20%22%22', '%09%22%22', '%0A%22%22', '%0C%22%22', '%60%60', '%20%60%60', '%09%60%60', '%0A%60%60', '%0C%60%60']);
    ...
    it('filter uriPathInDoubleQuotedAttr state transition test', function() {
      testutils.test_yav(filter.uriPathInDoubleQuotedAttr, ['foo&%3C%3E\'%22%60%20%09%0A%0B%0C%0D', '%0C', '', '\'\'', '%20\'\'', '%09\'\'', '%0A\'\'', '%0C\'\'', '%22%22', '%20%22%22', '%09%22%22', '%0A%22%22', '%0C%22%22', '%60%60', '%20%60%60', '%09%60%60', '%0A%60%60', '%0C%60%60']);
    ...
    it('filter uriPathInUnQuotedAttr state transition test', function() {
      testutils.test_yav(filter.uriPathInUnQuotedAttr, ['foo&%3C%3E&#39;%22%60%20%09%0A%0B%0C%0D', '%0C', '\uFFFD', '&#39;&#39;', '%20&#39;&#39;', '%09&#39;&#39;', '%0A&#39;&#39;', '%0C&#39;&#39;', '%22%22', '%20%22%22', '%09%22%22', '%0A%22%22', '%0C%22%22', '%60%60', '%20%60%60', '%09%60%60', '%0A%60%60', '%0C%60%60']);
      testutils.test_yu(filter.uriPathInUnQuotedAttr, ['http://6.6.6.6/?q&#61;%5Bsomewhere%5D', null, null, null, null, null, null, '%5B%5D?&&#61;#/:;']);
    ...
    it('filter uriPathInHTMLComment state transition test', function() {
      testutils.test_yc(filter.uriPathInHTMLComment, ['--%3E%20--!%3E%20%3C!--%5Bif%20IE%5D%3E%3Cscript%3Ealert(%22yahoo\'s%20filters%22)%3C/script%3E', 'foo-- ', 'foo--! ', '%5Bif%20IE%5D', 'foo- ', 'foo- ', '%3E%3Cscript%3Ealert(1)%3C/script%3E', '----------%3E%3Cscript%3Ealert(1)%3C/script%3E', '--%00%3E']);
      testutils.test_yu(filter.uriPathInHTMLComment);
    });
    it('filter uriComponentInSingleQuotedAttr state transition test', function() {
      testutils.test_yav(filter.uriComponentInSingleQuotedAttr, ['foo%26%3C%3E&#39;%22%60%20%09%0A%0B%0C%0D', '%0C', '', '&#39;&#39;', '%20&#39;&#39;', '%09&#39;&#39;', '%0A&#39;&#39;', '%0C&#39;&#39;', '%22%22', '%20%22%22', '%09%22%22', '%0A%22%22', '%0C%22%22', '%60%60', '%20%60%60', '%09%60%60', '%0A%60%60', '%0C%60%60']);
    ...
    it('filter uriComponentInDoubleQuotedAttr state transition test', function() {
      testutils.test_yav(filter.uriComponentInDoubleQuotedAttr, ['foo%26%3C%3E\'%22%60%20%09%0A%0B%0C%0D', '%0C', '', '\'\'', '%20\'\'', '%09\'\'', '%0A\'\'', '%0C\'\'', '%22%22', '%20%22%22', '%09%22%22', '%0A%22%22', '%0C%22%22', '%60%60', '%20%60%60', '%09%60%60', '%0A%60%60', '%0C%60%60']);
    ...
    it('filter uriComponentInUnQuotedAttr state transition test', function() {
      testutils.test_yav(filter.uriComponentInUnQuotedAttr, ['foo%26%3C%3E&#39;%22%60%20%09%0A%0B%0C%0D', '%0C', '\uFFFD', '&#39;&#39;', '%20&#39;&#39;', '%09&#39;&#39;', '%0A&#39;&#39;', '%0C&#39;&#39;', '%22%22', '%20%22%22', '%09%22%22', '%0A%22%22', '%0C%22%22', '%60%60', '%20%60%60', '%09%60%60', '%0A%60%60', '%0C%60%60']);
    ...
    it('filter uriComponentInHTMLComment state transition test', function() {
      testutils.test_yc(filter.uriComponentInHTMLComment, ['--%3E%20--!%3E%20%3C!--%5Bif%20IE%5D%3E%3Cscript%3Ealert(%22yahoo\'s%20filters%22)%3C%2Fscript%3E', 'foo-- ', 'foo--! ', '%5Bif%20IE%5D', 'foo- ', 'foo- ', '%3E%3Cscript%3Ealert(1)%3C%2Fscript%3E', '----------%3E%3Cscript%3Ealert(1)%3C%2Fscript%3E', '--%00%3E']);
    ...
    it('filter uriFragmentInSingleQuotedAttr state transition test', function() {
      testutils.test_yav(filter.uriFragmentInSingleQuotedAttr, ['foo%26%3C%3E&#39;%22%60%20%09%0A%0B%0C%0D', '%0C', '', '&#39;&#39;', '%20&#39;&#39;', '%09&#39;&#39;', '%0A&#39;&#39;', '%0C&#39;&#39;', '%22%22', '%20%22%22', '%09%22%22', '%0A%22%22', '%0C%22%22', '%60%60', '%20%60%60', '%09%60%60', '%0A%60%60', '%0C%60%60']);
    ...
    it('filter uriFragmentInDoubleQuotedAttr state transition test', function() {
      testutils.test_yav(filter.uriFragmentInDoubleQuotedAttr, ['foo%26%3C%3E\'%22%60%20%09%0A%0B%0C%0D', '%0C', '', '\'\'', '%20\'\'', '%09\'\'', '%0A\'\'', '%0C\'\'', '%22%22', '%20%22%22', '%09%22%22', '%0A%22%22', '%0C%22%22', '%60%60', '%20%60%60', '%09%60%60', '%0A%60%60', '%0C%60%60']);
    ...
    it('filter uriFragmentInUnQuotedAttr state transition test', function() {
      testutils.test_yav(filter.uriFragmentInUnQuotedAttr, ['foo%26%3C%3E&#39;%22%60%20%09%0A%0B%0C%0D', '%0C', '\uFFFD', '&#39;&#39;', '%20&#39;&#39;', '%09&#39;&#39;', '%0A&#39;&#39;', '%0C&#39;&#39;', '%22%22', '%20%22%22', '%09%22%22', '%0A%22%22', '%0C%22%22', '%60%60', '%20%60%60', '%09%60%60', '%0A%60%60', '%0C%60%60']);
