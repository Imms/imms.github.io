...
(function(process) {
  !function(e, t) {
    "object" == typeof exports && "object" == typeof module ? module.exports = t(require('react')) : "function" == typeof define && define.amd ? define(["react"], t) : "object" == typeof exports ? exports.reactMarkdown = t(require('react')) : e.reactMarkdown = t(e.React);
  }(this, function(e) {
    return function(e) {
      function t(n) {
        if (r[n])
      ...
      var n = r(25),
          ...
          q = new RegExp(o + "|" + _, "gi"),
          T = function(e) {
            return e.charCodeAt(0) === a ? e.charAt(1) : u(e);
          },
          B = function(e) {
      ...
      function n(e) {
        ...
        if (e.escapeHtml || !e.skipHtml)
          return u(e.isBlock ? "div" : "span", t, r);
      }
      function i(e) {
 ...
 while (!r.react);
      ...
      function u(e, t, r) {
        var n = Array.isArray(r) && r.reduce(o, []),
            i = [e, t].concat(n || r);
      ...
      function l(e, t, r, n) {
        var i,
            a = {key: t};
        switch (r.sourcePos && e.sourcepos && (a["data-sourcepos"] = s(e.sourcepos)), e.type) {
          case "HtmlInline":
          case "HtmlBlock":
          ...
          case "CodeBlock":
            ...
            u.length > 0 && u[0].length > 0 && (a.language = u[0]);
            break;
          case "Code":
        ...
        return Array.isArray(l) && (a.children = l.reduce(o, []) || null), a;
      }
      function c(e) {
        return e ? e.sourcepos ? s(e.sourcepos) : c(e.parent) : null;
      }
      function p(e) {
        for (var t,
            r,
          ...
          if (f === C ? (s = C + v, v++) : (s = C, v = 0), f = C, n = t.entering, u = !n, r = t.node, p = null, o) {
            if (r !== o && !("Paragraph" === r.type && i(r) || this.skipHtml && ("HtmlBlock" === r.type || "HtmlInline" === r.type))) {
              var y = r === o,
            ...
            o = r, r.react = {children: []};
        }
        return o.react.children;
      }
      function f(e) {
          ...
          C = {
            ...
            List: function(e) {
              var t = "Bullet" === e.type ? "ul" : "ol",
                  r = v(e);
              return null !== e.start && 1 !== e.start && (r.start = e.start.toString()), u(t, r, e.children);
            },
            CodeBlock: function(e) {
              var t = e.language && "language-" + e.language,
                  r = u("code", {className: t}, e.literal);
              return u("pre", v(e), r);
            },
            Code: function(e) {
              return u("code", v(e), e.children);
            },
            Heading: function(e) {
              return u("h" + e.level, v(e), e.children);
            },
            Text: null,
            Softbreak: null
          };
 ...
 while (t);
          ...
          F = function(e) {
            ...
            if (t = a.match(E))
              u.type = "Bullet", u.bulletChar = t[0][0];
            else {
              if (!(t = a.match(A)))
                return null;
              u.type = "Ordered", u.start = parseInt(t[1]), u.delimiter = t[2];
            }
 ...
 while (e.column - n < 5 && (r === h || r === l));
            var o = q(e.currentLine, e.offset) === -1,
                s = e.column - n;
            return s >= 5 || s < 1 || o ? (u.padding = t[0].length + 1, e.column = n, e.offset = i, q(e.currentLine, e.offset) === h && e.advanceOffset(1, !0)) : u.padding = t[0].length + s, u;
          },
          I = function(e, t) {
          ...
          R = [function(e) {
            ...
            var r;
            return e.indented && "List" !== t.type || !(r = F(e)) ? 0 : (e.closeUnmatchedBlocks(), "List" === e.tip.type && I(t._listData, r) || (t = e.addChild("List", e.nextNonspace), t._listData = r), t = e.addChild("Item", e.nextNonspace), t._listData = r, 1);
          }, function(e) {
            return e.indented && "Paragraph" !== e.tip.type && !e.blank ? (e.advanceOffset(s, !0), e.closeUnmatchedBlocks(), e.addChild("CodeBlock", e.offset), 2) : 0;
          }],
          U = function(e, t) {
            for (var r,
                n,
          ...
          j = function() {
            ...
            this.blank = "\n" === e || "\r" === e || "" === e, this.nextNonspace = r, this.nextNonspaceColumn = n, this.indent = this.nextNonspaceColumn - this.column, this.indented = this.indent >= s;
          },
          M = function(e) {
            var t,
                r = !0,
        ...
        var r = String.fromCharCode,
            ...
            i = function() {
              ...
              if (!o)
                return "";
              for (var s = ""; ++u < o; ) {
                var l = Number(arguments[u]);
                if (!isFinite(l) || l < 0 || l > 1114111 || n(l) !== l)
                  return String.fromCharCode(65533);
                l <= 65535 ? a.push(l) : (l -= 65536, e = (l >> 10) + 55296, t = l % 1024 + 56320, a.push(e, t)), (u + 1 === o || a.length > i) && (s += r.apply(null, a), a.length = 0);
              }
              return s;
            };
        e.exports = i;
      ...
      var i = r(1).escapeXml,
          ...
          c = function(e) {
            ...
            for (v.time && console.time("rendering"); i = p.next(); ) {
              if (s = i.entering, o = i.node, t = [], v.sourcepos) {
                var C = o.sourcepos;
              ...
              switch (o.type) {
                ...
                case "HtmlInline":
                  ...
                  break;
                case "CustomInline":
                  s && o.onEnter ? m(o.onEnter) : !s && o.onExit && m(o.onExit);
                  break;
                case "Link":
                  s ? (v.safe && l(o.destination) || t.push(["href", g(o.destination, !0)]), o.title && t.push(["title", g(o.title, !0)]), m(a("a", t))) : m(a("/a"));
                  break;
                case "Image":
                  s ? (0 === d && m(v.safe && l(o.destination) ? '<img src="" alt="' : '<img src="' + g(o.destination, !0) + '" alt="'), d += 1) : (d -= 1, 0 === d && (o.title && m('" title="' + g(o.title, !0)), m('" />')));
                  break;
                case "Code":
                ...
                case "Paragraph":
                  ...
                  break;
                case "BlockQuote":
                  s ? (b(), m(a("blockquote", t)), b()) : (b(), m(a("/blockquote")), b());
                  break;
                case "Item":
                  s ? m(a("li", t)) : (m(a("/li")), b());
                  break;
                case "List":
                  if (n = "Bullet" === o.listType ? "ul" : "ol", s) {
                    var y = o.listStart;
                  ...
                  break;
                case "Heading":
                  n = "h" + o.level, s ? (b(), m(a(n, t))) : (m(a("/" + n)), b());
                  break;
                case "CodeBlock":
                ...
                case "HtmlBlock":
                  ...
                  break;
                case "CustomBlock":
                  b(), s && o.onEnter ? m(o.onEnter) : !s && o.onExit && m(o.onExit), b();
                  break;
                case "ThematicBreak":
                  b(), m(a("hr", t, !0)), b();
                  break;
      ...
      "use strict";
      e.exports.version = "0.24.0", e.exports.Node = r(2), e.exports.Parser = r(9), e.exports.HtmlRenderer = r(11), e.exports.XmlRenderer = r(15);
    }, function(e, t, r) {
      "use strict";
      function n(e) {
        return {
      ...
      var p = 10,
          ...
          ie = function(e) {
            var t,
                r,
                n;
            return (t = this.match(M)) ? (r = t.slice(1, t.length - 1), n = new i("Link"), n._destination = o("mailto:" + r), n._title = "", n.appendChild(K(r)), e.appendChild(n), !0) : !!(t = this.match(z)) && (r = t.slice(1, t.length - 1), n = new i("Link"), n._destination = o(r), n._title = "", n.appendChild(K(r)), e.appendChild(n), !0);
          },
          ae = function(e) {
            var t = this.match(B);
            if (null === t)
          ...
          ue = function(e) {
            ...
            if (e === w || e === x)
              ...
              for (; this.peek() === e; )
                d++, this.pos++;
            return 0 === d ? null : (t = 0 === m ? "\n" : this.subject.charAt(m - 1), n = this.peek(), r = n === -1 ? "\n" : l(n), s = G.test(r), c = S.test(r), p = G.test(t), f = S.test(t), i = !(s || c && !p && !f), a = !(p || f && !s && !c), e === h ? (u = i && (!a || f), o = a && (!i || c)) : e === w || e === x ? (u = i && !a, o = a) : (u = i, o = a), this.pos = m, {
              numdelims: d,
              can_open: u,
              can_close: o
            });
          ...
          oe = function(e, t) {
            ...
            var u = K(n);
            return t.appendChild(u), this.delimiters = {
              cc: e,
              numdelims: i,
              node: u,
          ...
          ce = function(e) {
            ...
            for (; null !== r; ) {
              ...
              if (!r.can_close || m !== h && m !== f && m !== w && m !== x)
                ...
                if (n = r, m === f || m === h)
                  if (p) {
                    s = r.numdelims < 3 || t.numdelims < 3 ? r.numdelims <= t.numdelims ? r.numdelims : t.numdelims : r.numdelims % 2 === 0 ? 2 : 1, a = t.node, u = r.node, t.numdelims -= s, r.numdelims -= s, a._literal = a._literal.slice(0, a._literal.length - s), u._literal = u._literal.slice(0, u._literal.length - s);
                    var g = new i(1 === s ? "Emph" : "Strong");
                    for (l = a._next; l && l !== u; )
                      c = l._next, l.unlink(), g.appendChild(l), l = c;
                    a.insertAfter(g), le(t, r), 0 === t.numdelims && (a.unlink(), this.removeDelimiter(t)), 0 === r.numdelims && (u.unlink(), o = r.next, this.removeDelimiter(r), r = o);
                  } else
                    r = r.next;
                else
          ...
          fe = function() {
            var e = this.match(F);
            return null === e ? (e = this.match(I), null === e ? null : o(s(e))) : o(s(e.substr(1, e.length - 2)));
          },
          he = function() {
            var e = this.match(Y);
          ...
          ge = function(e) {
            var t,
                ...
                s,
                l = !1;
            for (this.pos += 1, t = this.pos, s = this.delimiters; null !== s && s.cc !== m && s.cc !== v; )
              s = s.previous;
            if (null === s)
              return e.appendChild(K("]")), !0;
            if (!s.active)
              return e.appendChild(K("]")), this.removeDelimiter(s), !0;
            if (r = s.cc === v, this.peek() === E)
              ...
              o = 0 === f || 2 === f ? this.subject.slice(s.index, t) : this.subject.slice(p, p + f), 0 === f && (this.pos = c);
              var h = this.refmap[u(o)];
            ...
            if (l) {
              ...
              var g,
                  b;
              for (g = s.node._next; g; )
                b = g._next, g.unlink(), d.appendChild(g), g = b;
              if (e.appendChild(d), this.processEmphasis(s.previous), s.node.unlink(), !r)
                for (s = this.delimiters; null !== s; )
                  s.cc === m && (s.active = !1), s = s.previous;
              return !0;
            }
            return this.removeDelimiter(s), this.pos = t, e.appendChild(K("]")), !0;
          },
          be = function(e) {
            var t;
          ...
          ve = function(e) {
            var t;
            return !!(t = this.match(J)) && (this.options.smart ? e.appendChild(K(t.replace(P, "…").replace(j, function(e) {
              var t = 0,
                  r = 0;
          ...
          ye = function(e, t) {
            ...
            if (this.pos++, this.spnl(), n = this.parseLinkDestination(), null === n || 0 === n.length)
              return this.pos = o, 0;
            var s = this.pos;
            this.spnl(), i = this.parseLinkTitle(), null === i && (i = "", this.pos = s);
            var l = !0;
            if (null === this.match(X) && ("" === i ? l = !1 : (i = "", this.pos = s, l = null !== this.match(X))), !l)
              return this.pos = o, 0;
            var c = u(r);
      ...
      var i = r(1).escapeXml,
          ...
          s = function(e) {
            ...
            for (E.time && console.time("rendering"), h += '<?xml version="1.0" encoding="UTF-8"?>\n', h += '<!DOCTYPE CommonMark SYSTEM "CommonMark.dtd">\n'; n = f.next(); )
              if (s = n.entering, i = n.node, p = i.type, l = i.isContainer, c = "ThematicBreak" === p || "Hardbreak" === p || "Softbreak" === p, r = o(p), s) {
                switch (t = [], p) {
                  case "Document":
      ...
      function o(e, t) {
        ...
        return function(e) {
          return e.replace(t, r).replace(d, u).replace(h, a);
        };
      }
      function s(e) {
        return e.replace(m, a).replace(d, u).replace(h, a);
      }
      var l = n(r(5)),
          c = i(l);
      t.XML = o(l, c);
      ...
      function u(e) {
        return g(function(t, r) {
          var n = -1,
              ...
              a = i > 1 ? r[i - 1] : void 0,
              u = i > 2 ? r[2] : void 0;
          for (a = e.length > 3 && "function" == typeof a ? (i--, a) : void 0, u && s(r[0], r[1], u) && (a = i < 3 ? void 0 : a, i = 1), t = Object(t); ++n < i; ) {
            var o = r[n];
            o && e(t, o, n, a);
          }
          return t;
      ...
      function s(e, t, r) {
        if (!d(r))
          return !1;
        var n = typeof t;
        return !!("number" == n ? p(r) && o(t, r.length) : "string" == n && t in r) && c(r[t], e);
      }
      function l(e) {
      ...
      function n(e, t) {
        return L.call(e, t) || "object" == typeof e && t in e && null === u(e);
      }
      function i(e) {
        return T(Object(e));
      }
      ...
      function v(e) {
        ...
        var r = o(e),
            ...
            c = u.length;
        for (var f in e)
          !n(e, f) || a && ("length" == f || s(f, c)) || t && "constructor" == f || u.push(f);
        return u;
      }
      ...
      function o(e) {
        return "symbol" == typeof e || u(e) && w.call(e) == b;
      }
      function s(e) {
        if (!e)
          return 0 === e ? e : 0;
      ...
      function n(e, t) {
        ...
        return "string" != typeof t && (t = n.defaultChars), i = r(t), e.replace(/(%[a-f0-9]{2})+/gi, function(e) {
          ...
          for (t = 0, r = e.length; t < r; t += 3)
            n = parseInt(e.slice(t + 1, t + 3), 16), n < 128 ? l += i[n] : 192 === (224 & n) && t + 3 < r && (a = parseInt(e.slice(t + 4, t + 6), 16), 128 === (192 & a)) ? (s = n << 6 & 1984 | 63 & a, l += s < 128 ? "��" : String.fromCharCode(s), t += 3) : 224 === (240 & n) && t + 6 < r && (a = parseInt(e.slice(t + 4, t + 6), 16), u = parseInt(e.slice(t + 7, t + 9), 16), 128 === (192 & a) && 128 === (192 & u)) ? (s = n << 12 & 61440 | a << 6 & 4032 | 63 & u, l += s < 2048 || s >= 55296 && s <= 57343 ? "���" : String.fromCharCode(s), t += 6) : 240 === (248 & n) && t + 9 < r && (a = parseInt(e.slice(t + 4, t + 6), 16), u = parseInt(e.slice(t + 7, t + 9), 16), o = parseInt(e.slice(t + 10, t + 12), 16), 128 === (192 & a) && 128 === (192 & u) && 128 === (192 & o)) ? (s = n << 18 & 1835008 | a << 12 & 258048 | u << 6 & 4032 | 63 & o, s < 65536 || s > 1114111 ? l += "����" : (s -= 65536, l += String.fromCharCode(55296 + (s >> 10), 56320 + (1023 & s))), t += 9) : l += "�";
          return l;
        });
      }
      var i = {};
      ...
      function n(e, t, i) {
        var a,
            ...
            l,
            c = "";
        for ("string" != typeof t && (i = t, t = n.defaultChars), "undefined" == typeof i && (i = !0), l = r(t), a = 0, u = e.length; a < u; a++)
          if (o = e.charCodeAt(a), i && 37 === o && a + 2 < u && /^[0-9a-f]{2}$/i.test(e.slice(a + 1, a + 3)))
            c += e.slice(a, a + 3), a += 2;
          else if (o < 128)
            c += l[o];
          else if (o >= 55296 && o <= 57343) {
            if (o >= 55296 && o <= 56319 && a + 1 < u && (s = e.charCodeAt(a + 1), s >= 56320 && s <= 57343)) {
      ...
      t._getPrivFilters = function() {
        ...
        function t(e, t, r, n) {
          function i(e, r, i, u) {
            return r ? (r = Number(r[0] <= "9" ? r : "0" + r), n ? _(r) : 128 === r ? "€" : 130 === r ? "‚" : 131 === r ? "ƒ" : 132 === r ? "„" : 133 === r ? "…" : 134 === r ? "†" : 135 === r ? "‡" : 136 === r ? "ˆ" : 137 === r ? "‰" : 138 === r ? "Š" : 139 === r ? "‹" : 140 === r ? "Œ" : 142 === r ? "Ž" : 145 === r ? "‘" : 146 === r ? "’" : 147 === r ? "“" : 148 === r ? "”" : 149 === r ? "•" : 150 === r ? "–" : 151 === r ? "—" : 152 === r ? "˜" : 153 === r ? "™" : 154 === r ? "š" : 155 === r ? "›" : 156 === r ? "œ" : 158 === r ? "ž" : 159 === r ? "Ÿ" : r >= 55296 && r <= 57343 || 13 === r ? "�" : a.frCoPt(r)) : t[i || u] || e;
          }
          ...
          s = n.createClass({
            ...
            render: function() {
              var e = this.props.containerProps || {},
                  t = new a(this.props),
                  r = u.parse(this.props.source || "");
              if (this.props.walker)
                for (var i,
                    o = r.walker(); i = o.next(); )
                  this.props.walker.call(this, i, o);
      ...
      s.types = a.types, s.renderers = a.renderers, s.uriTransformer = a.uriTransformer, e.exports = s;
    }]);
  });
})(require('process'));
