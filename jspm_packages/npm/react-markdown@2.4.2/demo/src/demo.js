...
var Markdown = require('../../src/react-markdown');
...
var Demo = module.exports = React.createClass({
  ...
  render: function() {
    return (h('div', {className: 'demo'}, h('div', {className: 'editor-pane'}, h(MarkdownControls, {
      onChange: this.onControlsChange,
      mode: this.state.htmlMode
    }), h(Editor, {
      value: this.state.markdownSrc,
      onChange: this.onMarkdownChange
    })), h('div', {className: 'result-pane'}, h(Markdown, {
      className: 'result',
