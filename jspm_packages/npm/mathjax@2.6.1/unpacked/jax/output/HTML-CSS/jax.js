    ...
    var FONTTEST = MathJax.Object.Subclass({
      ...
      testCollection: function(name) {
        ...
        font.family = {
          TeX: "MathJax_Size1",
          STIX: "STIXSizeOneSym"
        }[name] || name.replace(/-(Math)?/, "") + "MathJax_Size1";
        if (name === "STIX") {
      ...
      testFont: function(font) {
        ...
        if (!font.isWebFont && !family.match(/^(STIX|MathJax)|'/)) {
          family = family.replace(/_/g, " ").replace(/([a-z])([A-Z])/g, "$1 $2").replace(/ Jax/, "Jax") + "','" + family + "','" + family + "-";
          if (font.weight) {
            family += "Bold";
          }
          ;
      ...
      getComparisonWidths: function(string, noStyleChar) {
        ...
        for (var i = 1,
            m = this.comparisonFont.length; i < m; i++) {
      ...
      fontFace: function(name) {
        ...
        if (type === "otf") {
          ...
          dir = AJAX.fileURL(HTMLCSS.webfontDir + "/woff");
    ...
    HTMLCSS.Augment({
      ...
      Config: function() {
        ...
        if (font) {
          ...
          MESSAGE(["CantFindFontUsing", "Can't find a valid font using %1", "[" + this.config.availableFonts.join(", ") + "]"], null, 3000);
      ...
      PreloadWebFonts: function() {
        if (!HTMLCSS.allowWebFonts || !HTMLCSS.config.preloadWebFonts)
          return;
        for (var i = 0,
            m = HTMLCSS.config.preloadWebFonts.length; i < m; i++) {
      ...
      Translate: function(script, state) {
        ...
        HUB.signal.Post(["New Math Pending", jax.inputID]);
      ...
      postTranslate: function(state, partial) {
        ...
        for (i = state.HTMLCSSlast, m = state.HTMLCSSeqn; i < m; i++) {
          ...
          if (script && script.MathJax.elementJax) {
            ...
            HUB.signal.Post(["New Math", script.MathJax.elementJax.inputID]);
          }
        }
        if (this.forceReflow) {
      ...
      getW: function(span) {
        ...
        if ((span.bbox && w >= 0 && !this.initialSkipBug && !this.msieItalicWidthBug) || this.negativeBBoxes || !span.firstChild) {
          W = span.offsetWidth;
      ...
      MeasureSpans: function(SPANS) {
        ...
        for (i = 0, m = SPANS.length; i < m; i++) {
          ...
          if (bbox.exactW || bbox.width || bbox.w === 0 || bbox.isMultiline || (this.config.noReflows && bbox.exactW !== false)) {
            if (!parent.bbox) {
              parent.bbox = bbox;
            }
            continue;
          }
          if (this.negativeBBoxes || !span.firstChild || (bbox.w >= 0 && !this.initialSkipBug) || (bbox.w < 0 && this.msieNegativeBBoxBug)) {
            spans.push([span]);
      ...
      placeBox: function(span, x, y, noclip) {
        ...
        if (!span.noAdjust) {
          HH += 1;
          HH = Math.round(HH * this.em) / this.em;
          if (this.msieInlineBlockAlignBug) {
      ...
      positionDelimiter: function(span, h) {
        ...
        span.bbox.h += h;
        if (h) {
          if (this.safariVerticalAlignBug || this.konquerorVerticalAlignBug || (this.operaVerticalAlignBug && span.isMultiChar)) {
      ...
      checkFont: function(font, style) {
        ...
        return (font.family.replace(/'/g, "") === style.fontFamily.replace(/'/g, "") && (font.style || "normal") === (style.fontStyle || "normal") && (font.weight || "normal") === weight);
      },
      ...
      handleChar: function(span, font, c, n, text) {
        ...
        if (C.c == null) {
          if (n <= 0xFFFF) {
            ...
            var N = n - 0x10000;
            C.c = String.fromCharCode((N >> 10) + 0xD800) + String.fromCharCode((N & 0x3FF) + 0xDC00);
          }
        }
    ...
    MathJax.Hub.Register.StartupHook("mml Jax Ready", function() {
      ...
      MML.mbase.Augment({
        ...
        HTMLaddAttributes: function(span) {
          if (this.attrNames) {
            ...
            for (var i = 0,
                m = copy.length; i < m; i++) {
              var id = copy[i];
              if (ignore[id] == false || (!skip[id] && !ignore[id] && defaults[id] == null && typeof(span[id]) === "undefined")) {
        ...
        HTMLhandleColor: function(span) {
          ...
          if ((values.mathbackground && values.mathbackground !== MML.COLOR.TRANSPARENT) || borders || padding) {
            var bbox = span.bbox,
        ...
        HTMLdrawBBox: function(span) {
          var bbox = span.bbox;
          var box = HTMLCSS.Element("span", {style: {
      ...
      MML.chars.Augment({toHTML: function(span, variant, remap, chars) {
      ...
      MML.entity.Augment({toHTML: function(span, variant, remap, chars) {
      ...
      MML.mi.Augment({toHTML: function(span) {
      ...
      MML.mn.Augment({toHTML: function(span) {
          span = this.HTMLhandleSize(this.HTMLcreateSpan(span));
          span.bbox = null;
          var variant = this.HTMLgetVariant();
          for (var i = 0,
      ...
      MML.mo.Augment({
        toHTML: function(span) {
          ...
          if (text.length === 1 && parent && parent.isa(MML.munderover) && this.CoreText(parent.data[parent.base]).length === 1) {
          ...
          if (values.largeop) {
            ...
            if (HTMLCSS.safariVerticalAlignBug && span.lastChild.nodeName === "IMG") {
              span.lastChild.style.verticalAlign = HTMLCSS.Em(HTMLCSS.unEm(span.lastChild.style.verticalAlign || 0) / HTMLCSS.em - p / span.scale);
      ...
      MML.mtext.Augment({toHTML: function(span) {
          span = this.HTMLhandleSize(this.HTMLcreateSpan(span));
          var variant = this.HTMLgetVariant();
      ...
      MML.merror.Augment({toHTML: function(span) {
      ...
      MML.mspace.Augment({toHTML: function(span) {
          span = this.HTMLcreateSpan(span);
      ...
      MML.mphantom.Augment({
        toHTML: function(span, HW, D) {
          ...
          if (this.data[0] != null) {
            ...
            for (var i = 0,
                m = span.childNodes.length; i < m; i++) {
      ...
      MML.mpadded.Augment({
        toHTML: function(span, HW, D) {
          ...
          if (this.data[0] != null) {
            ...
            span.bbox.exact = !!((this.data[0] && this.data[0].data.length == 0) || dimen.exec(values.height) || dimen.exec(values.width) || dimen.exec(values.depth));
      ...
      MML.mrow.Augment({
        HTMLlineBreaks: function(span) {
          ...
          return (HTMLCSS.config.linebreaks.automatic && span.bbox.w > HTMLCSS.linebreakWidth) || this.hasNewline();
        },
        HTMLstretchH: function(box, w) {
          this.HTMLremoveColor();
          var span = this.HTMLspanElement();
      ...
      MML.mfrac.Augment({
        toHTML: function(span) {
          ...
          if (values.bevelled) {
            ...
            var t = HTMLCSS.thickness2em(values.linethickness, this.scale) * this.mscale,
                p,
                q,
                u,
                v;
            ...
            v *= scale;
            if (t === 0) {
              p = Math.max((isDisplay ? 7 : 3) * HTMLCSS.TeX.rule_thickness, 2 * mt);
      ...
      MML.msqrt.Augment({
        toHTML: function(span) {
          ...
          q = Math.max(t + p / 4, 1.5 * HTMLCSS.TeX.min_rule_thickness / this.em);
        ...
        toHTML: function(span, HW, D) {
          ...
          for (i = 0, m = this.data.length; i < m; i++) {
            if (this.data[i] != null) {
              ...
              if (i == this.base) {
                ...
                stretch[i] = (D == null && HW != null ? false : this.data[i].HTMLcanStretch("Horizontal"));
              } else {
          ...
          for (i = 0, m = this.data.length; i < m; i++) {
            if (this.data[i] != null) {
              ...
              if (accent && box.bbox.w <= 1 / HTMLCSS.em + .0001) {
      ...
      MML.msubsup.Augment({
        toHTML: function(span, HW, D) {
          ...
          var x_height = HTMLCSS.TeX.x_height * scale,
              s = HTMLCSS.TeX.scriptspace * scale * .75;
          var sup,
              sub;
          ...
          var u = base.bbox.h - q,
              ...
              p;
          if (base.bbox.ic) {
            base.bbox.w -= base.bbox.ic;
            delta = 1.3 * base.bbox.ic + .05;
          }
          if (this.data[this.base] && HW == null && D == null && (this.data[this.base].type === "mi" || this.data[this.base].type === "mo")) {
      ...
      MML.annotation.Augment({toHTML: function(span) {
      ...
      MML.math.Augment({
        toHTML: function(span, node, phase) {
          ...
          if (!phase || phase === HTMLCSS.PHASE.I) {
            ...
            if (stack.style.position !== "relative")
            ...
            if (!this.isMultiline && this.Get("display") === "block" && span.bbox.width == null) {
              ...
              if (shift) {
                ...
                if (color) {
                  ...
                  color.style.marginRight = HTMLCSS.Em(R + (values.indentalign === "right" ? span.bbox.w + shift - span.bbox.w : 0));
      ...
      HUB.Browser.Select({
        MSIE: function(browser) {
          ...
          HTMLCSS.Augment({
            ...
            msieDisappearingBug: (mode >= 8),
            msieMarginScaleBug: (mode < 8),
            msiePaddingWidthBug: true,
            msieBorderWidthBug: quirks,
            msieFrameSizeBug: (mode <= 8),
            ...
            initialSkipBug: (mode < 8),
            msieNegativeBBoxBug: (mode >= 8),
            msieIE6: !isIE7,
            msieItalicWidthBug: true,
            FontFaceBug: (mode < 9),
        ...
        Firefox: function(browser) {
          ...
          if (browser.versionAtLeast("3.5")) {
            ...
            if (document.location.protocol !== "file:" || HUB.config.root.match(/^https?:\/\//) || (HUB.config.root + "/").substr(0, root.length) === root) {
              webFonts = "otf";
            }
          }
          HTMLCSS.Augment({
            ffVerticalAlignBug: !browser.versionAtLeast("20.0"),
            AccentBug: true,
        ...
        Safari: function(browser) {
          ...
          var trueSafari = navigator.appVersion.match(/ Safari\/\d/) && navigator.appVersion.match(/ Version\/\d/) && navigator.vendor.match(/Apple/);
          var android = (navigator.appVersion.match(/ Android (\d+)\.(\d+)/));
          var forceImages = (v3p1 && browser.isMobile && ((navigator.platform.match(/iPad|iPod|iPhone/) && !browser.versionAtLeast("5.0")) || (android != null && (android[1] < 2 || (android[1] == 2 && android[2] < 2)))));
          HTMLCSS.Augment({
            config: {styles: {".MathJax img, .MathJax nobr, .MathJax a": {
                  "max-width": "5000em",
                  "max-height": "5000em"
                }}},
            Em: ((browser.webkit || 0) >= 538 ? HTMLCSS.EmRounded : HTMLCSS.Em),
            rfuzz: .011,
            AccentBug: true,
            AdjustSurd: true,
            negativeBBoxes: true,
          ...
          if (trueSafari) {
            HTMLCSS.Augment({webFontDefault: (browser.isMobile ? "sans-serif" : "serif")});
          }
          if (browser.isPC) {
            HTMLCSS.Augment({
        ...
        Chrome: function(browser) {
          HTMLCSS.Augment({
            Em: HTMLCSS.EmRounded,
            cloneNodeBug: true,
            rfuzz: -.02,
            AccentBug: true,
            AdjustSurd: true,
            FontFaceBug: browser.versionAtLeast("32.0"),
            negativeBBoxes: true,
            safariNegativeSpaceBug: true,
            safariWebFontSerif: [""],
            forceReflow: true,
        ...
        Konqueror: function(browser) {
          HTMLCSS.Augment({konquerorVerticalAlignBug: true});
        }
      });
    });
